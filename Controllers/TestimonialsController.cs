...
namespace She_He_Store.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public IActionResult Approved(decimal? id)
        {
            var testimonial = _context.Testimonials.Where(t => t.Testimonialid == id).SingleOrDefault();
            if (testimonial != null)
            {
        ...
        public IActionResult Reject(decimal? id)
        {
            var testimonial = _context.Testimonials.Where(t => t.Testimonialid == id).SingleOrDefault();
            if (testimonial != null)
            {
        ...
        public async Task<IActionResult> Create([Bind("Testimonialid,Customername,Testimonialtext,Testimonialdate,Status,Userid")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Testimonialid,Customername,Testimonialtext,Testimonialdate,Status,Userid")] Testimonial testimonial)
        {
