...
namespace She_He_Store.Controllers
{
    public class CouponsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Couponid,Couponcode,Discountamount,Expirydate,Createddate,Isactive")] Coupon coupon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Couponid,Couponcode,Discountamount,Expirydate,Createddate,Isactive")] Coupon coupon)
        {
