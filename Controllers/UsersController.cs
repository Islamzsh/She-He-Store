...
namespace She_He_Store.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Userid,FirstName,LastName,ImageFile,Gender")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Userid,FirstName,LastName,ImageFile,Gender")] User user)
        {
            if (id != user.Userid)
            {
                return NotFound();
