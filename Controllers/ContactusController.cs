...
namespace She_He_Store.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Contactid,Address,Phone,Email,Subject,Message")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Contactid,Address,Phone,Email,Subject,Message")] Contactu contactu)
        {
